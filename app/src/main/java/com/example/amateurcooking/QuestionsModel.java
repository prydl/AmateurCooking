...
public class QuestionsModel extends AppCompatActivity {
    ...
    private void gameOver () {
        AlertDialog.Builder alertDialogueBuilder = new AlertDialog.Builder(QuestionsModel.this);
                ...
                .setPositiveButton("NEW GAME",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int i) {
                                ...
                                startActivity(new Intent(getApplicationContext(), QuestionsModel.class));
